import 'package:ezcheck_login_signup/intro_screens/intro_page1.dart';
import 'package:ezcheck_login_signup/intro_screens/intro_page2.dart';
import 'package:ezcheck_login_signup/intro_screens/intro_page3.dart';
  ...
  child: ElevatedButton(
    onPressed: () {
      ...
      if (_controller.page == 2) {
        ...
        // Go to the next page using the controller
    ...
    style: ElevatedButton.styleFrom(
      primary: Color(0xFF31434F), // Adjust the color as needed
